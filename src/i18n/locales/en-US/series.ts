...
const series = {
  ...
  '全剧资产提取': 'Full-script asset extraction',
  '完整剧本': 'Full script',
  '提取人物': 'Extract characters',
  '提取场景': 'Extract scenes',
  '提取道具': 'Extract props',
  '提取中…': 'Extracting…',
  '使用当前文本模型读取全剧剧本，成功后自动合并到共享资产库。': 'Uses the current text model to read the full script and automatically merge successful results into the shared asset library.',
  '请先填写全剧剧本。': 'Add the full series script first.',
  '已提取并添加 {count} 项{name}资产': 'Extracted and added {count} {name} assets',
  '全剧资产提取失败': 'Full-script asset extraction failed',
